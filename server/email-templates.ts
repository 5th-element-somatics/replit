        ...
        <div class="header">
            <div class="logo">
                <div class="tiger-icon">
                    <svg width="60" height="60" viewBox="0 0 120 120" style="fill: #1a0d1f;">
                        <!-- Twin Tigers Design inspired by your logo -->
                        <!-- Left Tiger -->
                        <path d="M20 60 C15 45 20 30 35 25 C45 20 55 30 50 45 C48 55 45 65 35 70 C25 75 20 65 20 60 Z" opacity="0.9"/>
                        <path d="M15 50 C18 48 22 50 20 53 C18 55 15 53 15 50 Z"/>
                        <path d="M25 45 C28 43 32 45 30 48 C28 50 25 48 25 45 Z"/>
                        
                        <!-- Right Tiger (mirrored) -->
                        <path d="M100 60 C105 45 100 30 85 25 C75 20 65 30 70 45 C72 55 75 65 85 70 C95 75 100 65 100 60 Z" opacity="0.9"/>
                        <path d="M105 50 C102 48 98 50 100 53 C102 55 105 53 105 50 Z"/>
                        <path d="M95 45 C92 43 88 45 90 48 C92 50 95 48 95 45 Z"/>
                        
                        <!-- Central connecting element -->
                        <path d="M50 40 C55 35 65 35 70 40 C65 45 55 45 50 40 Z"/>
                        <path d="M50 40 C45 35 35 35 30 40 C35 45 45 45 50 40 Z"/>
                        
                        <!-- Tiger stripes pattern -->
                        <path d="M30 35 L38 40 M32 50 L40 55 M75 35 L82 40 M78 50 L85 55" stroke="#1a0d1f" stroke-width="2" fill="none"/>
                        
                        <!-- Mystical elements -->
                        <circle cx="60" cy="25" r="2" opacity="0.6"/>
                        <circle cx="45" cy="20" r="1.5" opacity="0.6"/>
                        <circle cx="75" cy="20" r="1.5" opacity="0.6"/>
                    </svg>
                </div>
